...
| **4**      | **Geräteinformationen**         | Hier wird der Link zum Gerät in der Z2M Doku angezeigt und das entsprechende Bild von dem Gerät. Die Bilder werden von Z2M bereit gestellt und können teilweise abweichen. Sie werden modellbezogen unter `user/IPSZigbee2MQTT/icons` zwischengespeichert und erst beim Öffnen der Konfiguration geladen, damit sie den globalen Symcon-Snapshot nicht unnötig vergrößern.                                                                                                                                                                                                                                                                                    |
