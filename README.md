...
- Der von Zigbee2MQTT berechnete Taupunkt `dewpoint` wird bei nachträglicher Anlage als Float-Variable mit dem Symcon-Temperaturprofil `~Temperature` angelegt.
