...
class BridgeTest extends TestCase
{
    ...
    public function testCustomProfileScanOnlyListsOverridesFromAssignedInstances(): void
    {
        ...
        $this->assertSame('Select', $rowsByVariableID[$profileVariableID]['action']);
        $this->assertSame(
            'Test.Presentation',
    ...
    public function testRequestOptionsUsesTolerantAvailabilityTimeout(): void
    {
        $bridge = $this->createBridgeTestDouble([
            'status' => 'ok',
            'data'   => []
        ...
        $this->assertTrue($bridge->RequestOptions());
